...
BACKEND_DIR = Path(get_application_base_dir())
# Go up one level to project root, then to frontend/public
PROJECT_ROOT = BACKEND_DIR.parent
PUBLIC_DIR = PROJECT_ROOT / 'frontend' / 'public'
LOGS_DIR = BACKEND_DIR / 'debug'
...
LAST_RUN_FILE = BACKEND_DIR / '.last_run'
COMPREHENSIVE_RUN_FILE = BACKEND_DIR / '.last_comprehensive_run'
LOCK_FILE = BACKEND_DIR / '.lims_fetch.lock'
...
file_handler = logging.FileHandler(LOGS_DIR / 'lims_fetcher.log', mode='w', encoding='utf-8')
